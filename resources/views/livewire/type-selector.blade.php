<div>
    {{-- 🔍 Search box --}}
    <div class="mb-3">
        <input wire:model.debounce.300ms="query" type="text" placeholder="Search types..."
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        @forelse($results as $type)
            ...
            <button type="button" wire:click.prevent="toggle({{ $type->id }})"
                ...
                <span><x-type-icon :type="$type" /> </span>
    ...
    <div class="flex gap-2 mt-3">
        <input wire:model.defer="newName" type="text" placeholder="Add new type..."
