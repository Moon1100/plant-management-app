<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="themeManager()" x-init="initTheme()" x-bind:class="{ 'dark': $root.darkMode }">
    <head>
        <meta charset="utf-8">
        ...
        <script>
            function themeManager() {
                return {
                    ...
                    apply() { if (this.darkMode) document.documentElement.classList.add('dark'); else document.documentElement.classList.remove('dark'); }
                }
            }
        </script>
    </body>
