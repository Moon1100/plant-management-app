...
<div class="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h1 class="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">New Farm</h1>
        ...
        <form method="POST" action="{{ route('farms.store') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input name="name" class="w-full mt-1 px-3 py-2 border rounded dark:bg-gray-800" />
                </div>

                <div>
                    <label class="block text-sm text-gray-700 dark:text-gray-200 ">Location</label>
                    <input name="location" class="w-full mt-1 px-3 py-2 border rounded dark:bg-gray-800" />
                </div>

                <div>
                    <label class="block text-sm text-gray-700 dark:text-gray-200 ">Description</label>
                    <textarea name="description" class="w-full mt-1 px-3 py-2 border rounded dark:bg-gray-800"></textarea>
                </div>
