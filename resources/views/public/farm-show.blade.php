        ...
        @if($farm->plants && $farm->plants->count())
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach($farm->plants as $plant)
                    <div class="group flex flex-col bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                        {{-- Image --}}
                        <div class="relative w-full aspect-[4/3] overflow-hidden rounded-t-2xl">
                            ...
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-green-100 to-green-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center text-3xl rounded-t-2xl">
                                    🌿
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex-1 flex flex-col p-4 rounded-b-2xl">
                            <h3 class="font-semibold text-lg text-gray-800 dark:text-white group-hover:text-green-500 transition-colors duration-300">
                                {{ $plant->name }}
                            </h3>
